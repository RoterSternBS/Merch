...
(function () {
  ...
  const DICT = {
    de: {
      ...
      "hero.ctaActive": "Alle Sammelbestellungen →",
      "hero.howtoToggle": "So funktioniert's",
      "hero.sideTitle": "Sammelbestellung",
    ...
    en: {
      ...
      "hero.ctaActive": "All group orders →",
      "hero.howtoToggle": "How it works",
      "hero.sideTitle": "Group order",
    ...
    ar: {
      ...
      "hero.ctaActive": "← كل الطلبات الجماعية",
      "hero.howtoToggle": "كيف يعمل",
      "hero.sideTitle": "طلب جماعي",
